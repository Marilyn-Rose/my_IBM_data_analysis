...
1. Select Region
2. Select Year
3. Division to display
        Pie Chart to display Monthly Average Estimated
            Fire Aread for the selected Regions in the 
            selected Year
        
        Bar Chart to display Monthly Average Count of Pixels
            for Presumed Vegetation Fires for the seleced 
            Regions in the selected Year
'''
import pandas as pd
import dash
